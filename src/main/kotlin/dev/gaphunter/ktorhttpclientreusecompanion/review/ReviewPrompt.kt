package dev.gaphunter.ktorhttpclientreusecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.ktorhttpclientreusecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.ktorhttpclientreusecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Ktor HttpClient Reuse Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33904-ktor-httpclient-reuse-companion/reviews"
